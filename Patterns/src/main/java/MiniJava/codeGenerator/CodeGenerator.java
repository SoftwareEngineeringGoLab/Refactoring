...
public class CodeGenerator {
    ...
    public void call() {
        ...
        Address temp = new Address(memory.getNewTemp(), t);
    ...
    public void add() {
        Address temp = new Address(memory.getNewTemp(), varType.Int);
        memory.updateLastTempIndex();
        Address s2 = ss.pop();
        Address s1 = ss.pop();
    ...
    public void equal() {
        Address temp = new Address(memory.getNewTemp(), varType.Bool);
        memory.updateLastTempIndex();
        Address s2 = ss.pop();
        Address s1 = ss.pop();
        if (s1.varType != s2.varType) {
